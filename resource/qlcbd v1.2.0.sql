...
--
-- Host: localhost
-- Generation Time: Mar 01, 2014 at 06:18 PM
...
INSERT INTO `can_bo` (`Ma_Can_Bo`, `Ma_CV_Chinh`, `Ho_Ten_CB`, `Ngay_Gia_Nhap`, `Ngay_Tuyen_Dung`, `Ngay_Bien_Che`, `Ma_ĐVCT_Chinh`) VALUES
...
CREATE TABLE IF NOT EXISTS `ly_lich` (
  `Ma_CB` int(11) NOT NULL,
  `So_Hieu_CB` varchar(30) DEFAULT NULL,
  ...
  `Luong_Thu_Nhap_Nam` bigint(20) unsigned DEFAULT NULL,
  `Nguon_Thu_Khac` varchar(254) DEFAULT NULL,
  `Loai_Nha_Đuoc_Cap` varchar(62) DEFAULT NULL,
  `Dien_Tich_Nha_Đuoc_Cap` int(10) unsigned DEFAULT NULL,
  `Loai_Nha_Tu_Xay` varchar(62) DEFAULT NULL,
  `Dien_Tich_Nha_Tu_Xay` int(10) unsigned DEFAULT NULL,
  `Dien_Tich_Đat_O_Tu_Mua` int(10) unsigned DEFAULT NULL,
  `Dien_Tich_Đat_O_Đuoc_Cap` int(10) unsigned DEFAULT NULL,
  `Dien_Tich_Đat_San_Xuat` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`Ma_CB`),
