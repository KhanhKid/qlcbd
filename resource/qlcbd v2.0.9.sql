...
--
-- Host: localhost
-- Generation Time: Mar 26, 2014 at 12:58 AM
...
CREATE TABLE IF NOT EXISTS `khen_thuong` (
  ...
  `Ma_Khen_Thuong` int(11) unsigned NOT NULL,
  ...
  `Ma_DS_Khen_Thuong` int(10) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `ky_luat` (`Ma_CB`, `Ma_Ky_Luat`, `Ngay_Quyet_Đinh`, `Hinh_Thuc`, `Ly_Do_Ky_Luat`, `Cap_Ra_Quyet_Đinh`) VALUES
(12, 1, '2014-03-25', 'Khiển trách', 'lơ là công việc', 'cấp trường');
...
INSERT INTO `qua_trinh_cong_tac` (`Ma_CB`, `Ma_QTCT`, `Tu_Ngay`, `Đen_Ngay`, `Chuc_Danh`, `Chuc_Vu`, `Đon_Vi_Cong_Tac`) VALUES
