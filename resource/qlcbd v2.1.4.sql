...
--
-- Host: localhost
-- Generation Time: Mar 30, 2014 at 11:22 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_layThongTinLyLich`(IN `macb` INT)
    NO SQL
SELECT can_bo.Ma_Can_Bo,đon_vi.Ten_Đon_Vi,can_bo.Ho_Ten_CB,can_bo.Ma_Quan_Ly, ly_lich.So_Hieu_CB, can_bo.Ngay_Roi_Khoi, can_bo.Trang_Thai, can_bo.Tham_Gia_CLBTT,
...
(29, NULL, NULL, 'Hoàng Ngọc Hòa', '2014-03-26', '2014-03-26', '2014-03-26', NULL, NULL, 1, b'0'),
...
('2014-03-30 05:15:20', 4, 'fdf', 'd', NULL, -1),
('2014-03-30 06:28:37', 3, 'v', 'f', '3_1396135717.zip', 1),
('2014-03-30 06:31:26', 3, 'fdf', 'àd', '3_1396135886.zip', 0),
...
('2014-03-30 07:20:17', 3, 'a', 'a', '3_1396138817.zip', 0),
('2014-03-30 07:20:41', 3, 'g', 'g', '3_1396138841.zip', 0),
...
('2014-03-30 15:11:40', 3, 'a', 'fd', '3_1396167100.zip', 0),
('2014-03-30 15:11:55', 3, 'a', 'fd', NULL, 1),
('2014-03-30 15:13:53', 3, 'a', 'fd', NULL, 1),
('2014-03-30 15:20:50', 3, 'f', 'a', NULL, 1),
('2014-03-30 15:21:30', 3, 'f', 'f', NULL, -1),
('2014-03-30 18:13:02', 3, 'a', 'd', '3_1396177982.zip', 1),
('2014-03-30 18:13:48', 3, 'a', 'd', '3_1396178028.zip', 1),
('2014-03-30 18:42:51', 3, 'fd', 'a112', '3_1396179771.zip', 1),
('2014-03-30 18:43:50', 3, '32', '32', NULL, 1),
('2014-03-30 22:50:05', 4, 'bb', 'bb', '4_1396194605.zip', 1);
...
(9, 'A', 'Đơn Vị A', 4, NULL, 25, '2014-03-20', NULL, '12 Nguyễn Thị Minh Khai, Phường 4, Quận 3, TP.HCM', 'toasoan@baotuoitre.vn', '+8423253543', '<p>kh&ocirc;ng c&oacute;</p>\r\n', 0),
(10, 'B', 'Đơn Vị B', 4, NULL, 25, '2001-01-13', NULL, '', 'donvib@gmail.com', '(08) 372 52002', '<p>m&ocirc; tả đơn vị</p>\r\n', 1);
