...
--
-- Host: localhost
-- Generation Time: Mar 12, 2014 at 06:47 AM
...
(1, NULL, 1, 'Nguyễn Trác Thức', '2006-10-10', NULL, NULL, 'UIT', NULL, b'1', b'0'),
(2, NULL, 3, 'Lê Đức Thịnh', '2007-07-06', NULL, NULL, 'UIT', NULL, b'1', b'0'),
(3, NULL, 5, 'Hoàng Anh Hùng', '2009-03-04', NULL, NULL, 'BTT', NULL, b'1', b'0'),
(4, NULL, 5, 'Trần Đình Thi', '2011-02-03', NULL, NULL, 'CQCTTĐ', NULL, b'1', b'1'),
(12, '01-56-11', 1, 'Nguyễn Tuấn Anh', '2014-01-08', '2014-01-01', '2014-01-13', 'HDBC', NULL, b'1', b'0');
...
CREATE TABLE IF NOT EXISTS `cong_tac_nuoc_ngoai` (
  ...
  PRIMARY KEY (`Lan_CTNN`,`Ma_CB`),
  KEY `Lan_CTNN` (`Lan_CTNN`)
...
INSERT INTO `cong_tac_nuoc_ngoai` (`Ma_CB`, `Lan_CTNN`, `Tu_Ngay`, `Đen_Ngay`, `Đia_Điem`, `Noi_Dung`, `Cap_Cu_Đi`, `Kinh_Phi`) VALUES
(4, 1, '2014-03-01', '2014-03-08', 'Nhật Bản', 'giao lưu văn hóa sinh viên Việt - Nhật', 'cấp thành phố', 'đài thọ hoàn toàn (khoảng 10 triệu VNĐ), 10 triệu cho phí phát sinh'),
(12, 1, '2013-10-01', '2014-03-20', 'Hàn Quốc', 'giao lưu các trường đại học châu Á', 'cấp trường', 'đài thọ hoàn toàn (cao nhất 20 triệu)');
...
INSERT INTO `đon_vi` (`Ma_Đon_Vi`, `Ten_Đon_Vi`, `Ma_Khoi`, `Ma_Truong_ĐV`, `Ma_Ban_Chap_Hanh`, `Ngay_Thanh_Lap`, `Chuc_Nang_ĐV`, `Đia_Chi`, `Email`, `So_Đien_Thoai`, `Mo_Ta`, `Trang_Thai`) VALUES
('BTT', 'Báo Tuổi Trẻ', NULL, NULL, 26, '2014-01-25', 'thông tin liên lạc', '12 Nguyễn Thị Minh Khai, Phường 4, Quận 3, TP.HCM', 'toasoan@baotuoitre.vn', '+8423253543', '<p>M&ocirc; tả cho đơn vị B&aacute;o Tuổi trẻ</p>\r\n', 1),
('CQCTTĐ', 'Cơ Quan Chuyên Trách Thành Đoàn', 2, NULL, NULL, NULL, NULL, NULL, NULL, '', 'Cơ Quan Chuyên Trách Thành Đoàn quản lý các vấn đề thành đoàn TP HCM', 1),
('HDBC', 'Huyện Đoàn Bình Chánh', 1, NULL, NULL, '1970-01-01', NULL, NULL, NULL, '', 'Mô tả huyện Đoàn Bình Chánh', 1),
('HDCC', 'Huyện Đoàn Củ Chi', 1, NULL, NULL, '1970-01-01', NULL, NULL, NULL, '', 'Mô tả huyện Đoàn Củ Chi', 1),
('HDCG', 'Huyện Đoàn Cần Giờ', 1, NULL, NULL, '1970-01-01', NULL, NULL, NULL, '', 'Mô tả huyện Đoàn Cần Giờ', 1),
('UEL', 'Trường Đại Học Kinh Tế - Luật', 4, NULL, 28, '2010-01-21', NULL, NULL, NULL, '', '<p>M&ocirc; tả cho ĐH Kinh Tế - Luật</p>\r\n', 1),
('UIT', 'Trường Đại Học Công Nghệ Thông Tin', NULL, 3, 29, '2006-06-08', NULL, NULL, NULL, '', '<p>M&ocirc; tả cho trường ĐH C&ocirc;ng nghệ Th&ocirc;ng tin - Đại học Quốc Gia TPHCM</p>\r\n', 1),
('UT', 'Trường ĐH Bách Khoa', 4, NULL, NULL, '2014-01-01', NULL, NULL, NULL, '', '<p><strong>M&ocirc; tả cho trường ĐH B&aacute;ch Khoa</strong></p>\r\n', 1);
